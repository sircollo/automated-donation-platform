# Generated by Django 4.0.4 on 2022-07-04 11:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target_amount', models.IntegerField(choices=[(100000, '$100,000'), (200000, '$200,000'), (300000, '$300,000'), (400000, '$400,000'), (500000, '$500,000'), (700000, '$700,000'), (600000, '$600,000'), (800000, '$800,000'), (900000, '$900,000'), (1000000, '$1M+')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('charity', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='adp.charity')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('donation_frequency', models.CharField(choices=[('Once', 'Once'), ('Monthly', 'Monthly'), ('Annualy', 'Annualy')], max_length=20)),
                ...
                ('charity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='adp.charity')),
                ('donor_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='adp.donor')),
            ],
        ),
    ]
